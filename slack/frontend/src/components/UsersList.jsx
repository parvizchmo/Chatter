...
const UsersList = ({activeChannel}) => {
    ...
    const startDirectMessage = async (targetUser) => {
        ...
        try {
            ...
            console.log("Error creating DM", e)
        }
    }

    if (isLoading) return <div className='team-channel-list__message'> Loading Users</div>
    if (isError) return <div className='team-channel-list__message'> Error Loading Users</div>
                    ...
                    <button key={user.id}
                        ...
                        <div className='flex items-center gap-2 w-full'>
                            <div className="relative">
                                ...
                                <CircleIcon className={`w-2 h-2 absolute -bottom-0.5 -right-0.5 ${
                                    user.online ? "text-green-500 fill-green-500" : "text-gray-500 fill-gray-500"
                                }`}/>
                            </div>
