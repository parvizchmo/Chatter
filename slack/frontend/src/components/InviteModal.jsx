...
const   InviteModal = ({channel, onClose}) => {
    ...
    const handleInvite = async () => {
        ...
        try {
            ...
            console.log("Failed to invite users", err)
        } finally {
            setIsInviting(false);
        }
        ...
        <div className='create-channel-modal-overlay'>
            ...
            <div className="create-channel-modal">
                ...
                <div>
                    ...
                    <div className="create-channel-model__form">
                    ...
                    {/*ACITONS*/}
                        ...
                        <div className="create-channel-modal__actions mt-4">
                            <button className='btn btn-secondary' onClick={onClose} disabled={isInviting}>Cancel</button>

<button className='btn btn-primary' onClick={handleInvite} disabled={!selectedMembers.length || isInviting}>
